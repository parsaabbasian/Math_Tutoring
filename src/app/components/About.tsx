      ...
      <div className={`container ${styles.aboutContainer}`}>
        ...
        <div className={styles.aboutContent}>
          ...
          <p className={styles.aboutText}>
            Hi! My name is <strong>Avin</strong>, and I am a <strong>Mechanical Engineering student at York University</strong> with a strong passion for mathematics, teaching, and helping students build confidence in their learning journey. I graduated from the <strong>OSSD program</strong> in Canada and am highly familiar with the Canadian teaching system, learning expectations, and methods used across different grade levels.
          </p>
          <p className={styles.aboutText}>
            Over the past years, I have worked privately with students from elementary to high school, focusing on making math <strong>simple, understandable, and enjoyable</strong>. My unique <strong>bilingual approach</strong> allows me to teach fluently in both <strong>English and Persian (Farsi)</strong>, which is especially helpful for bilingual families adapting to the Canadian education system.
          </p>
          <p className={styles.aboutText}>
