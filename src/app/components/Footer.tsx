    ...
    <footer className={styles.footer}>
      <div className={`container ${styles.footerContainer}`}>
        ...
        <div className={styles.links}>
          ...
          <Link href="/#how-it-works" className={styles.link}>{nav.howItWorks}</Link>
        ...
        <div className={styles.socials}>
          ...
          <a href="https://www.instagram.com/avin.mathtutoring/" target="_blank" rel="noopener noreferrer" title={t.instagram} className={`${styles.link} ${styles.socialLink}`}>
